    ...
    cv::Mat& filteredDepth)
{
    ...
    cv::Mat rawDepthMat(depthImage->height(), depthImage->width(), CV_16UC1, depthImage->data());
    ...
    const cv::Mat& camera_matrix)
{
    ...
    bool res1 = cv::solvePnPRansac(points1_3d, points2, camera_matrix, dc, rvec, tvec, false, 10000, 2.0, 0.995, inliers, cv::SOLVEPNP_SQPNP);
